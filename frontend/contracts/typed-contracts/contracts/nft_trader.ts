...
import { ContractAbi } from '../contract-info/nft_trader';
import QueryMethods from '../query/nft_trader';
import BuildExtrinsicMethods from '../build-extrinsic/nft_trader';
import TxSignAndSendMethods from '../tx-sign-and-send/nft_trader';
import MixedMethods from '../mixed-methods/nft_trader';
import EventsClass from '../events/nft_trader';
