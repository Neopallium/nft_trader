...
import { ContractFile } from '../contract-info/nft_trader';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.Ticker } ticker,
	*/
   	async "new" (
		ticker: ArgumentTypes.Ticker,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, ticker);
			let response;
