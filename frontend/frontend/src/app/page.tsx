...
import { NftTraderContractInteractions } from '@/components/web3/nft-trader-contract-interactions'
    ...
    <>
      <div className="container relative flex grow flex-col items-center justify-center py-10">
        ...
        <div className="mt-12 flex w-full flex-wrap items-start justify-center gap-4">
          ...
          {/* NftTrader Read/Write Contract Interactions */}
          <NftTraderContractInteractions />
        </div>
      </div>
    </>
  )
